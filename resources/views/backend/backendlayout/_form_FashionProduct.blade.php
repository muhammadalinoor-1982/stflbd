        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="row mbn-20">
                    ...
                    <div class="col-lg-4 col-12 mb-20">
                        <div class="row mbn-15">
                            <div class="col-12 mb-15">
                                <select class="form-control form-control-sm" name="fashion_id">
                                    <option>Select Fashion Item</option>
                                    @foreach($fashions as $fashion)
                                        <option value="{{$fashion->id}}" {{(@$editData->fashion_id == $fashion->id)?"selected":""}}>{{$fashion->name}}</option>
                                    @endforeach
                                </select>
                                @error('fashion_id')
                    ...
                    <div class="col-lg-4 col-12 mb-20">
                        <div class="row mbn-15">
                            <div class="col-12 mb-15"><input type="text" name="name" value="{{@$editData->name}}" class="form-control form-control-sm @error('name') is-invalid @enderror" placeholder="Fashion Product Name"></div>
                            @error('name')
                            <div class=" text-danger">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-lg-12 col-12 mb-20">
                        <div class="row mbn-15">
                            <div class="col-12 mb-15">
                                <img src="{{(@$editData->image)?url('public/backend/images/Fashion_images/'.@$editData->image):url('public/backend/images/Fashion_images/noimage.jpg')}}"  alt="" class="product-image rounded-circle">
