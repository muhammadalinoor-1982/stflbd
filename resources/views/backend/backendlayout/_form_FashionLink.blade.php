        ...
        <div class="box-body">
            <div class="row mbn-20">
                <div class="col-lg-8 col-12 mb-20">
                    <h6 class="mb-15">Fashion Link</h6>
                    <div class="row mbn-15">
                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                <img id="showImage" src="{{(!empty($editData->image))?url('public/backend/images/FashionLink_images/'.$editData->image):url('public/backend/images/FashionLink_images/noimage.jpg')}}" width="30%">
                            </div>
                        </div>
