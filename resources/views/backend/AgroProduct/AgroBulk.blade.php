...
@section('content')
    <form method="post" action="{{route('AgroProduct.bulkproduct')}}" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <!--Form Size Start-->
            <div class="col-12 mb-30">
                <div class="box">
                    <div class="box-head">
                        <h3 class="title">Agro Bulk Product Upload</h3>
                    ...
                    <div class="col-12 mt-10"><button class="button button-primary button-outline"><a href="{{url('public/backend/BulkExampleFile/AgroBulk/AgroProduct.xlsx')}}">Download Sample file</a></button></div>
                    <div class="box-body">
