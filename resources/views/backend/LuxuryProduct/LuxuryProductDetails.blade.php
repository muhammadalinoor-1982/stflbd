    ...
    <div class="row mbn-30">
        ...
        <div class="col-12 mb-30">
            ...
            <div class="row mbn-15">
                ...
                <div class="col-12 col-md-4 mb-15">
                    <h4 class="text-primary fw-600 m-0">{{ $editData->Luxury->name}}</h4>
                </div>
        ...
        <div class="col-12 mb-30">
            <div class="order-details-customer-info row mbn-20">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-20">
                    ...
                    <ul>
                        <li> <span>Image</span> <span><img src="{{(@$editData->image)?url('public/backend/images/Luxury_images/'.$editData->image):url('public/backend/images/Luxury_images/no_image.png')}}"  alt="" class="product-image rounded-circle" width="50%"></span> </li>
