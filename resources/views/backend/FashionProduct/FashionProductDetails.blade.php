...
@section('content')
    <div class="row mbn-30">
        ...
        <div class="col-12 mb-30">
            <a title="Back to Mail Menu" class="edit button button-box button-xs button-info" href="{{ route('FashionProduct.view')}}"><i class="zmdi zmdi-mail-reply-all"></i></a>
            <div class="row mbn-15">
                <div class="col-12 col-md-4 mb-15">
                    <h4 class="text-primary fw-600 m-0">{{ $editData->name }}</h4>
                </div>
                <div class="col-12 col-md-4 mb-15">
                    <h4 class="text-primary fw-600 m-0">{{ $editData->Fashion->name}}</h4>
                </div>
        ...
        <div class="col-12 mb-30">
            <div class="order-details-customer-info row mbn-20">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-20">
                    ...
                    <ul>
                        <li> <span>Image</span> <span><img src="{{(@$editData->image)?url('public/backend/images/Fashion_images/'.$editData->image):url('public/backend/images/Fashion_images/no_image.png')}}"  alt="" class="product-image rounded-circle" width="50%"></span> </li>
                        ...
                        <li> <span>Production Lead Time</span> <span>{{ $editData->production_lead_time }}</span> </li>
                        <li> <span>Delivery Lead Time</span> <span>{{ $editData->delivery_lead_time }}</span> </li>
